...
export default function Home() {
  return (
    <main className="overflow-x-hidden">
      <Header />
      {/* to align the margin left and right */}
      <div className="ml-4 mr-4 md:ml-11 md:mr-11 lg:mr-[20vh] lg:ml-[20vh] ">
        <div className=" mt-24">
          <Card />
        </div>
        ...
        <div className="mt-28 gap-5">
          ...
          <div className="flex justify-center items-center flex-wrap gap-8 md:gap-10 lg:gap-14 mt-16 mx-2 sm:mx-4">
